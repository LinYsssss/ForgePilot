...
ForgePilot is a requirement-driven AI code review platform: 9 backend packages, 21 tables across 11 Flyway migrations, a 6-entry / 11-route frontend, GitHub and GitLab providers, and a three-arm evaluation whose holdout was consumed exactly once. Both test suites are green with zero skips; read the count from a run rather than from a document.
