...
- 当前授权边界：**Phase 1（最小绿地底座）已于 2026-08-20 获授权开始**；只实施 Phase 1 并停在其评审闸门，Phase 2 及以后仍需用户单独授权。
