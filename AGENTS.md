...
- **Current delivered shape, re-verified on 2026-08-23**: 8 backend top-level packages, 16 business tables across 7 Flyway migrations, `./mvnw -B -ntp verify` green at 316 tests with zero skips, a 6-entry / 10-route frontend with 35 green tests, GitHub and GitLab providers, and a completed three-arm formal evaluation. Quote these numbers, not the older 307 / 3-entry / 7-route figures.
