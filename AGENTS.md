...
8 backend top-level packages, 20 business tables across 10 Flyway migrations, `./mvnw -B -ntp verify` green at 338 tests with zero skips, a 6-entry / 11-route frontend with 42 green tests, GitHub and GitLab providers, and a completed three-arm evaluation. Quote these numbers.
