...
- **Current delivered shape, re-verified on 2026-08-24**: 8 backend top-level packages, 19 business tables across 9 Flyway migrations, `./mvnw -B -ntp verify` green at 323 tests with zero skips, a 6-entry / 11-route frontend with 35 green tests, GitHub and GitLab providers, and a completed three-arm formal evaluation. Quote these numbers, not the older 317 / 8-migration or 316 / 16-table / 10-route figures.
