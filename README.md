...
| 维度 | 事实 |
|---|---|
| 后端 | Spring Boot 4.1 模块化单体，8 个顶层业务包，20 张业务表 / 10 个 Flyway 迁移，332 个测试 |
| 前端 | Vue 3 + TypeScript + Vite，6 个一级导航 / 11 条产品路由，12 个测试文件 / 37 个测试 |
...
验证使用 Testcontainers 真实 PostgreSQL 15 + pgvector：后端 332 个测试零跳过，前端 lint / typecheck / 37 个测试 / build 全绿。
